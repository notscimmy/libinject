...
/*
	...
	not require "UnhookProc" to be exported. This is the most standard dll
	injection technique that utilizes CreateRemoteThread and LoadLibrary

	@param pid the target proces id to inject into
